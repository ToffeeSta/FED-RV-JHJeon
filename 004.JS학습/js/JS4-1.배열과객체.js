...
/* 
  2-1. new 키워드로 Object객체 생성하여 셋팅하기
    ...
    즉, 변수 = {}
    여기서는 new 키워드 생성 방식도 된다는 것을 체험함
    객체는 셋팅시 반드시 중괄호{}를 사용함
    중괄호 안에는 {속성명:갑,속성명:갑,속성명:갑,........}
    */
...
// 출력하기
target[3].innerHTML = `당신이 좋아하는 남자배우는? ${SSG["너의 이름은?"]} / 몸무게를 아세요? ${SSG.몸무게} <br> 생년월일은? ${SSG["생일"]} / 대표작은? ${SSG.대표작}`;
